...
* gpt 모델에 들어가는 prompt 형태
* 데이터셋의 input열과 output열로 full prompt 생성 시, Answer 뒤에 정답 문장이 추가됨 
<pre><code>
"prompt_input": '''~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~
### Question: She enjoy read books in her spare time.
### Answer: She enjoys reading books in her spare time.
...
* eos token = 2
* 혹시 prompt를 하나의 문장이라고 학습한게 아닐까..?
<pre><code>
{'input_ids': 
  [1, 887, 526, 385, 18860, 4223, 260, 3406, 1058, 23588, 515, 22221, 3014, 297, 12115, 29889, 13, 
...
전혀 상관없는 문장, 이전에 나온 문장, 현재문장이 예시문장과 혼합된 문장 등으로 다양하게 출력..

PeftModel로 lora_weight를 안 불러왔는데 그럼 모델의 어떤 정보를 가져온거지..??
